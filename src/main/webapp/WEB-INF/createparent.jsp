...
<div id="middle" style="width: 100%">
  ...
  <form action="createparent.php?page=createparent" method="post"  style="color:white; width: 50%; margin-left: 35%; height: fit-content; display: flex; flex-direction: column; gap: 1rem; ">
    ...
    <input type="submit" name="saveStd"
           value="Register Parent" style="padding: 10px 10px; background-color: #4CAF50; color: white; border: none; cursor: pointer; border-radius: 4px; font-size: 16px;" />
