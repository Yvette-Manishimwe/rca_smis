    ...
    <div id="middle" style="color: white">
        <c:if test="${authenticatedUser !=null}">
            <div class="options">
                ...
                <a href="createmarks.php?page=createmarks"><button>
            ...
            <table style="border: 0;">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td  style="border: 1px solid white">Student Name</td>
                        <td  style="border: 1px solid white">Subject</td>
                        <td  style="border: 1px solid white">Marks</td>
                    ...
                    <c:forEach items="${marks}" var="mrk" varStatus="mrkstatus">
                        <tr>
                            <td  style="border: 1px solid white">${mrk.getStudentName()}</td>
                            <td  style="border: 1px solid white">${mrk.getSubject()}</td>
                            <td  style="border: 1px solid white">${mrk.getMarksObtained()}</td>
